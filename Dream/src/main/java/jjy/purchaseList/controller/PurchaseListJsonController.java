...
//					System.out.println("확인용"+sort);
					System.out.println("확인용 currentShowPageNo jsonView 에서: "+ currentShowPageNo);
//					System.out.println("=================================");
				// 확인용 ///////////////////////////////////////////////////
				...
				if( pagingPurchaseList.size() > 0) { // 조회한 구매내역이 있경우
					for( PurchaseListDTO pdto : pagingPurchaseList ) { 
					   ...
					   if(pageNo != 1) { //21이 마지막페이지인 경우 while문을 빠져나오고 22가 되면 다음을 붙이면 안된다.
						   pageBar += "<li class='page-item'><a class='page-link' href='buylist.dream?sizePerPage=10&currentShowPageNo=1&searchWord='>[맨처음]</a></li>";
...
//							   pageBar += "<li class='page-item'><a class='page-link' href='buylist.dream?sizePerPage=10&currentShowPageNo="+pageNo+"'>"+pageNo+"</a></li>";
					   ...
					   if( pageNo <= totalPage) { //21이 마지막페이지인 경우 while문을 빠져나오고 22가 되면 다음을 붙이면 안된다.
...
//						   pageBar += "<li class='page-item'><a class='page-link' href='buylist.dream?sizePerPage=10&currentShowPageNo="+totalPage+"'>[마지막]</a></li>";
						   ...
						   pageBar += "<li class='page-item'><a class='page-link' href='#'>[마지막]</a></li>";
					   }
