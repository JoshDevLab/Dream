...
public class SmsSend extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//String api_secret = "발급받은 본인의 API Key";
		...
		String mobile = request.getParameter("mobile");         // 받는 사람의 연락처
		String smsContent = request.getParameter("smsContent"); // 보낼 문자 내용 
        ...
        paraMap.put("text", smsContent);     // 문자내용  
                 					        ...
                 					        // 예약발송의 경우 key값은 datetime 으로 고정이다.
//      paraMap.put("datetime", "20221007120000"); // 예약전송시 날짜 설정 반드시 YYYYMMDDHHMISS 형식대로 해야함.
        
        String datetime = request.getParameter("datetime");
        if( datetime != null ) { // 예약문자인 경우 
        ...
        */
        ...
        // ~~~~ 확인용 json => {"group_id":"R2GkYskBSgPG6uVP","success_count":1,"error_count":0}
