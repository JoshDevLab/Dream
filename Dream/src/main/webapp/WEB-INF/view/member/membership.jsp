       ...
       <%-- .modal-dialog-scrollable을 .modal-dialog에 추가하여 페이지 자체가 아닌 모달 내부에서만 스크롤할 수 있습니다. --%>
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <h5>제２조 (용어의 정의)</h5>
               <p>
                  ① 로켓와우 서비스(이하 “본 서비스”라고 한다)란, 대상회원이 로켓와우 멤버십으로 가입함으로써 회사가 대상회원에게 추가적으로 제공하는 각종 서비스 및 관련 부가서비스 일체를 의미한다.
                  ② 회원이란, 『쿠팡 이용약관』에 동의하고 그 서비스를 이용하는 자로서, 본 서비스를 이용하기 위해 본 약관에 동의한 자를 의미한다.
                  ③ 대상회원이란, 『쿠팡 이용약관』에 동의하고 그 서비스를 이용하는 자로서, 본 서비스 중 개별 서비스를 이용할 수 있는 요건을 갖춘 자를 의미한다.
               ...
               <h5>제４조 (로켓와우 서비스 가입 신청)</h5>
               <p>
                  ① 로켓와우 서비스는 대상회원이 본 서비스를 위한 약관에 동의하고 결제정보를 입력함으로써 가입 신청할 수 있다.
